...
def make_button_handler(state: AppState, oled: OLEDDisplay, led=None, track_manager=None):
...
def main():
    ...
    try:
        with ExitStack() as stack:
            ...
            buttons.bind(on_press=make_button_handler(state, oled, led, track_manager))
